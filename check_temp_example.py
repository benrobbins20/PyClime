...
instrument = minimalmodbus.Instrument('COM10', 1)  # find the com device in device manager, 1: the slave address 
...
#print(instrument.read_register(100))               # reads the current chamber temp
